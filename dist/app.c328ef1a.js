...
var newsFeed = function newsFeed() {
  ...
  for (var i = (store.currentPage - 1) * store.pageSize; i < store.currentPage * store.pageSize; i++) {
    var _news$i = news[i],
        id = _news$i.id,
        title = _news$i.title,
        comments_count = _news$i.comments_count,
        user = _news$i.user,
        points = _news$i.points,
        time_ago = _news$i.time_ago,
        read = _news$i.read;
...
var newsContent = function newsContent() {
  ...
  var _getData = getData(contentUrl.replace("@id", id)),
      title = _getData.title,
      content = _getData.content,
      comments = _getData.comments;
  ...
  var makeComment = function makeComment(comments) {
    ...
    for (var i = 0; i < comments.length; i++) {
      var _comments$i = comments[i],
          user = _comments$i.user,
          _content = _comments$i.content,
          time_ago = _comments$i.time_ago,
          level = _comments$i.level;
      commentStr.push("\n        <div style=\"padding-left: ".concat(level * 20, "px;\" class=\"mt-4\">\n          <div class=\"text-gray-400\">\n            <i class=\"fa fa-sort-up mr-2\"></i>\n            <strong>").concat(user, "</strong> ").concat(time_ago, "\n          </div>\n          <p class=\"text-gray-700\">").concat(_content, "</p>\n        </div>\n      "));
...
},{}]},{},["C:/development/nvm/v16.8.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
